//############################# AXE DOCUMENTATION ########################################################################## 
//#
//#	Copyright:	(c)Copyright 2004-2013 Odin Technology Ltd. All Rights Reserved.
//#	Version:	v4.0
...
function applyXSLT(typeParam,xmlFile,enableback,manualview)
	{
		...
		{
			document.open();
			document.write('<!DOCTYPE html><html><head><script type="text/javascript" src="Documentation.js"></script><link type="text/css" rel="stylesheet" href="axe.css"/></head><body class="main">');
	
			document.write('<div id="resultdiv">');
