    ...
    class SeleniumTest
    {
        ...
        static void Main(string[] args)
        {
            try {
                ...
                {
                    axe.DataFileLoad(
                        @"C:\\Users\\knzul\\OneDrive\\Documents\\Axe Projects\\Example\\scripts\\debug\\Data\\OPRG005.xml",
                        "");
        ...
        {
            axe.InitializeTestDataSource("OPRG005", "", (axe.IsDataDriven("") ? axe.DataFileRowCount : 0),(axe.IsDataDriven("") ? axe.DataFileCurrentRow : 0));
            ...
            Driver driver = null;
            try {
                driver = new Driver(axe, @"C:\Program Files (x86)\Odin Technology\Axe\Selenium","Example", "OPRG005");
			...
			try
			{
				axe.TestBegin("OPRG005" ,"Verify registration of a new user - default title", "C:/Users/knzul/OneDrive/Documents/Axe Projects/Example/data/ExampleTests.xlsx", "MyTests", "C:/Users/knzul/OneDrive/Documents/Axe Projects/Example/results/debug/results.xml","");
...
// 
// 
				axe.SubtestBegin("usingNewUser5", "Register a new user with default title", "C:/Users/knzul/OneDrive/Documents/Axe Projects/Example/data/ExampleTests.xlsx", "Register");
				axe.StepBegin("[]Register", @"set", @"");
				driver.SetWindow("title=Odin Portal - Register");
				axe.StepEnd();

				axe.StepBegin("Name", @"set", @"Eric Redford");
				driver.FindElement("name=TextBoxName").SendKeys("Eric Redford");
				axe.StepEnd();
				...
				axe.StepBegin("DOB", @"set", @"15/09/1972");
				driver.FindElement("name=DOB").SendKeys("15/09/1972");
				axe.StepEnd();

				axe.StepBegin("Email", @"set", @"e.redford@testing.com");
				driver.FindElement("name=email").SendKeys("e.redford@testing.com");
				axe.StepEnd();
