    ...
    class SeleniumTest
    {
        ...
        static void Main(string[] args)
        {
            try {
                ...
                {
                    axe.DataFileLoad(
                        @"C:\\Users\\knzul\\OneDrive\\Documents\\Axe Projects\\Example\\scripts\\debug\\Data\\OPRG001.xml",
                        "");
...
// 
				...
				axe.StepBegin("Email", @"set", @"a.brown@testing.com");
				driver.FindElement("name=email").SendKeys("a.brown@testing.com");
				axe.StepEnd();
